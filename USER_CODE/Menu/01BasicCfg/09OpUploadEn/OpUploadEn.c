...
**
**--------------File Info---------------------------------------------------------------------------------
** File name:               OpUploadEn.c
** Latest modified Date:    2022-09-18
** Latest Version:          1.0
** Descriptions:            操作数据上传使能设置菜单项
**
**--------------------------------------------------------------------------------------------------------
** Created by:              超人力霸王
...
/*********************************************************************************************************
  内部使用变量
*********************************************************************************************************/
const MENU_ITEM_FUNC GmifOpUploadEn = {
    __menuItemCreate,
    __menuItemDel,
    __menuItemOnKey,
    __menuItemParamFmt
...
/*********************************************************************************************************
  操作上传使能菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibOpUploadEn = {                         /*  菜单项信息                  */
    "动作数据上传",
    (MENU_ITEM_FUNC *)&GmifOpUploadEn,
    0x0109,
