...
#define CAN3EWL         (*((volatile unsigned long *) 0xE004C018))     
#define CAN3SR          (*((volatile unsigned long *) 0xE004C01C))     
#define CAN3RFS         (*((volatile unsigned long *) 0xE004C020))
#define CAN3RID         (*((volatile unsigned long *) 0xE004C024))    
...
#define CAN4EWL         (*((volatile unsigned long *) 0xE0050018))     
#define CAN4SR          (*((volatile unsigned long *) 0xE005001C))     
#define CAN4RFS         (*((volatile unsigned long *) 0xE0050020))
#define CAN4RID         (*((volatile unsigned long *) 0xE0050024))    
...
#define CAN5EWL         (*((volatile unsigned long *) 0xE0054018))     
#define CAN5SR          (*((volatile unsigned long *) 0xE005401C))     
#define CAN5RFS         (*((volatile unsigned long *) 0xE0054020))
#define CAN5RID         (*((volatile unsigned long *) 0xE0054024)) 
...
#define CAN6EWL         (*((volatile unsigned long *) 0xE0058018))     
#define CAN6SR          (*((volatile unsigned long *) 0xE005801C))     
#define CAN6RFS         (*((volatile unsigned long *) 0xE0058020))
#define CAN6RID         (*((volatile unsigned long *) 0xE0058024))    
