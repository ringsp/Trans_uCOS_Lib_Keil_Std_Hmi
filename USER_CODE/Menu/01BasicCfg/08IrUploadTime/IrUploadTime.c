...
**
**--------------File Info---------------------------------------------------------------------------------
** File name:               IrUploadTime.c
** Latest modified Date:    2022-09-18
** Latest Version:          1.0
** Descriptions:            煤机位置上传时间间隔设置菜单
**
**--------------------------------------------------------------------------------------------------------
** Created by:              超人力霸王
...
/*********************************************************************************************************
  内部使用变量
*********************************************************************************************************/
const MENU_ITEM_FUNC GmifIrUploadTime = {
    __menuItemCreate,
    __menuItemDel,
    __menuItemOnKey,
    __menuItemParamFmt
...
static INT32S __menuItemCreate (MENU_ITEM_INFO *pmiiThis)
{
    ...
    *  ............
    */
    pmiiThis->pvPara = (void *)&Gdp.ucShearerDataInterval;
    return SYS_OK;
}
...
/*********************************************************************************************************
  煤机位置上传时间间隔菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibIrUploadTime = {                       /*  菜单项信息                  */
    "煤机数据",
    (MENU_ITEM_FUNC *)&GmifIrUploadTime,
    0x0108,
